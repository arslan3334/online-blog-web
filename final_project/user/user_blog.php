  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
       ...
       <a href="user_post_detail.php?post_id=<?php echo $post_data2['post_id']  ?>"  >Detail</a>
      </div>
    </div>
  </div>
</div> 
...
<!-- pagination boot tsrap start  -->
    ...
    <a class="page-link  bg-dark text-warning " href="user_blog.php?page=<?php echo $page - 1; ?>&blog_id=<?php echo $blog_id; ?>"  >PREVIOUS</a> 
    </li>
...
<li class="page-item active" aria-current="page">
 ...
 <a class="page-link bg-warning text-dark  " href="user_blog.php?page=<?php echo $i; ?>&blog_id=<?php echo $blog_id; ?>"><?php echo $i; ?></a>
...
<!-- 
    ...
    <li class="page-item active" aria-current="page">
            ...
            <a class="page-link bg-warning text-dark  " href="user_blog.php?page=<?php echo $i; ?>&blog_id=<?php echo $blog_id; ?>"><?php echo $i; ?></a></li>
...
<li class="page-item">
    ...
    <a class="page-link bg-dark text-warning  " href="user_blog.php?page=<?php echo $page + 1; ?>&blog_id=<?php echo $blog_id; ?>">NEXT</a>
    </li>
